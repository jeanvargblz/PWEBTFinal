...
<body>
	...
	<div class="container">
		...
		<div class="panel panel-info">
			<div class="panel-heading"><center><label>Administrador</label></center></div>
			<div class="panel-body">
				...
				<form role="form" action="/choseOption" method="post">
					...
					<div class="form-group">
						<label for="ejemplo_password_1">Type</label><select
					...
					<button type="submit" class="btn btn-sm btn-info">Ir</button>
				</form>
